...
### А. Общие требования <span style="color: limegreen">(5 баллов)<span>
...
### Б. Дуплексная передача <span style="color: limegreen">(2 балла)<span>
...
### В. Контрольные суммы <span style="color: limegreen">(1 балл)<span>
...
#### Демонстрация работы
Клиент и сервер из предыдущих заданий уже используют контрольные суммы (см. `proto.py`)

## Контрольные суммы <span style="color: limegreen">(2 балла)<span>

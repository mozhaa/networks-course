...
### Задание А. Основное приложение <span style="color: limegreen">(6 баллов)<span>
...
### Задание Б. Вывод имен промежуточных узлов <span style="color: limegreen">(2 балла)<span>
...
#### Демонстрация работы
Код расположен в файле `icmp-tracer/`. Сразу оба задания А и Б
...
## Использование протокола IPv6 <span style="color: limegreen">(2 балла)<span>
...
#### Демонстрация работы
Код расположен в папке `ipv6-upper/`.
